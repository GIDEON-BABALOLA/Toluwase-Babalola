...
" 1️⃣ Business problem: predicting the weekly stock level percentage using customer sales data"+
"2️⃣ Analysing the data: Clean, prepare, and extract relevant features (timestamp, temperature, stock level, product quantity, etc.)."+
"3️⃣ Data modelling and model development: a predictive ML model (random forest regressor) to predict the stock level percentage."+
"4️⃣ Model validation: validate the model's performance using metrics (MAE). presented the findings to the client." +
"5️⃣ Production and quality assurance: deploy the model into an IoT temperature sensor and ensure better quality if the client provides larger data containing more information (delivery time)."+
 "📊 Findings:"+
"- Fruits and vegetables had the highest number of sales, while spices and herbs had the least sales."+
"- The average unit price, quantity, and total money spent on groceries were $7.82, 2.5, and $19.71, respectively."+
"- The number of customers with standard and premium memberships was the same as non-members, while those with basic memberships were the least."+
"- Cash was the most frequent payment method used during that week."+
